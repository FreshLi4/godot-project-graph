...
- Phase 1 native GDScript editor addon foundation.
- Static asset scanning and exact resource dependency graph.
- Native graph view, search, asset navigation, and JSON export.
- Headless fixture tests and editor plugin smoke check.
- Deterministic organic force-directed layout with disk-filling phyllotaxis seeds.
